...
use Qq260101081\Model\Dao\AssignmentDao;
use Qq260101081\Model\Dao\ItemDao;
use Qq260101081\Model\Dao\RuleDao;
...
class BaseManager implements ManagerInterface
{
     ...
     * @var AssignmentDao;
     */
    protected $_assignmentDao;


    /**
     * 为用户分配一个角色
     *
     * @param Permission|Role $roleName
    ...
    {
        return $this->_assignmentDao->createRole($userId, $roleName);
    }
     ...
     * @throws \Swoft\Db\Exception\DbException
     */
    public function deleteAssignRole($userId)
    {
        return $this->_assignmentDao-> deleteRole($userId);
    }
    ...
    {
        return  $this->_ruleDao->getOne($name);
    }
    ...
    {
        return  $this->_ruleDao->update($name, $rule);
    }
    ...
    {
        return $this->_itemDao->createRole($name);
    }
    ...
    {
        return $this->_itemDao->getRole($name);
    }
    ...
    {
        return $this->_itemDao->getPermission($name);
    }
